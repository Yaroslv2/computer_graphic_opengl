...
Object::Object() : mode(GL_TRIANGLES), vaoID(0)
{
	if (glGenVertexArrays == NULL) {
		std::cout << "glGenVertexArrays is NULL" << std::endl;
	}
...
void Object::setMode(GLuint mode)
{
	this->mode = mode;
}

void Object::loadCoords(glm::vec3* verteces, size_t count)
{
...
void Object::loadColors(glm::vec3* colors, size_t count)
{
...
void Object::loadIndexes(GLuint* indices, size_t count)
{
	indexCount = count;
	glBindVertexArray(vaoID);
